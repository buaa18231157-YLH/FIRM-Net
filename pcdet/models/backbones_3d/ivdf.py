...
def feature_index_fusion(feature1, index1, feature2, index2):
    ...
    res = torch.zeros(feature1.shape[0] + feature2.shape[0], feature1.shape[1] + feature2.shape[1])
    res[:feature1.shape[0], :feature1.shape[1]] = feature1
    res[feature1.shape[0]:, feature1.shape[1]:] = feature2
    res[same_idx[0], feature1.shape[1]:] = res[same_idx[1], feature1.shape[1]:]
